...
Cálculo rápido de viabilidad: a S/1,000/mes y CPC real ~S/1.5–2.5 → 400–650 clics/mes. Con conversión landing 8–12% → 35–75 trials/mes. Con trial→pago 25% → 9–18 pagos/mes ≈ **S/450–1,200 MRR nuevos/mes** si se sostiene (validar con datos reales y recalibrar el modelo del PRONOSTICO_TRAFICO_REVENUE.md).
...
4. Registrar aprendizajes en `docs/marketing/` (qué ganó, por qué, dato).
