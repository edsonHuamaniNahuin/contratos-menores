...
Reclutar entre: los 7 suscriptores activos, los que compraron y cancelaron (entender el "por qué no"), trials que no convirtieron, y 2-3 prospects (ej. contactos de Honda del Perú S.A. — División Compras — para el caso corporativo). Lista en `documents/03-clientes-investigacion/candidatos-entrevistas.md`. 20-30 min por llamada o WhatsApp. Preguntas obligatorias:
...
## Entregables (escribir en `documents/03-clientes-investigacion/` del repo)
