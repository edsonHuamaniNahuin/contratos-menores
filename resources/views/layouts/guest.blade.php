    ...
    <div class="min-h-screen flex flex-col lg:flex-row">
        <div class="hidden lg:flex lg:w-1/2 bg-primary-500 text-white items-center justify-center p-12">
            <div class="max-w-md space-y-8">
                <div class="space-y-3">
                    <p class="text-sm  tracking-[0.4em] text-secondary-200">Alertas y seguimiento de procesos</p>
                    <div class="text-4xl font-bold leading-tight text-white">Vigilante SEACE</div>
                </div>
