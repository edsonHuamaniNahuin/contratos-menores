...
<body class="font-sans antialiased min-h-screen bg-neutral-50">
    ...
    <div class="max-w-3xl mx-auto px-6 py-16" x-data="mpCheckout()" x-cloak>
            ...
            <div class="grid md:grid-cols-5 gap-8">
                ...
                <div class="md:col-span-3">
                    <div class="bg-white rounded-3xl shadow-soft p-8 border border-neutral-100">
                        <h1 class="text-xl font-bold text-neutral-900 mb-1">Datos de pago</h1>
                        <p class="text-sm text-neutral-400 mb-6">Pago seguro. No necesitas cuenta de Mercado Pago.</p>
    ...
    <script>
        function mpCheckout() {
            ...
            return {
                ...
                processing: false,
                errorMessage: '',
                paymentResult: null, // null = form, 'success', 'failure'
                ...
                async submitPayment() {
                    ...
                    try {
                        // 1. Crear card token con MercadoPago.js
                        ...
                        if (data.success) {
                            ...
                            // Redirigir después de 2s para que vea el mensaje
                            setTimeout(() => {
                        ...
                        // Extraer mensaje de error del SDK
                        if (err && err.message) {
