...
<head>
    ...
    <title>404 - Página no encontrada | Vigilante SEACE</title>
...
<body class="bg-neutral-50 min-h-screen font-sans antialiased">
    <div class="min-h-screen flex items-center justify-center px-6 py-12">
        <div class="w-full max-w-lg text-center space-y-8">
            ...
            {{-- Ícono --}}
            <div class="mx-auto w-24 h-24 rounded-full bg-brand-800/10 flex items-center justify-center">
                <svg class="w-12 h-12 text-brand-800" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
            ...
            <div class="flex flex-col sm:flex-row items-center justify-center gap-3">
                <a href="{{ url('/') }}"
                   class="inline-flex items-center gap-2 px-6 py-3 bg-brand-800 text-white font-semibold text-sm rounded-full hover:bg-brand-600 transition-colors">
