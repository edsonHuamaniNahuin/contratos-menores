...
class AppServiceProvider extends ServiceProvider
{
    ...
    public function boot(): void
    {
        ...
        Gate::define('view-consumo-ia', fn ($user) => $user->hasPermission('view-consumo-ia'));
    Gate::define('view-analytics', fn ($user) => $user->hasPermission('view-analytics'));
        Gate::define('view-monitoreo-sistema', fn ($user) => $user->hasPermission('view-monitoreo-sistema'));
